    ...
    return (
      <form className='shadow-t-2xl fixed inset-x-0 bottom-0 mx-auto rounded-t-xl bg-primary p-5 text-sm text-white shadow-primary md:container md:static md:mt-5 md:rounded-xl md:shadow-2xl md:shadow-primary'>
        ...
        <div className='flex w-full flex-wrap gap-5 rounded-md md:flex-nowrap'>
          <label htmlFor='charge' className='basis-full md:basis-1/2'>
            <span>지출 항목</span>
            <input
              id='charge'
              name='charge'
          ...
          <label htmlFor='amount' className='basis-full md:basis-1/2'>
            <span>비용</span>
            <input
              id='amount'
              name='amount'
          ...
          <button
            type='submit'
            className='hover:bg-active focus:bg-active block basis-full rounded-md bg-secondary px-3.5 py-2 text-center shadow focus-within:outline-none md:mt-7 md:basis-0'
          >
